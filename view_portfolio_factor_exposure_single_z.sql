CREATE OR REPLACE VIEW public.view_portfolio_factor_exposure_single_z AS
WITH holdings AS (
    SELECT
...
factors AS (
    ...
    WHERE ticker_factor_beta_long.method = 'OLS_SINGLE_Z'::text
...
beta AS (
    ...
    WHERE t.method = 'OLS_SINGLE_Z'::text
)
SELECT
    f.factor_code,
    fm.factor_name,
