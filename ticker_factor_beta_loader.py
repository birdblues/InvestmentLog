...
SINGLE_FACTOR_CODES = [
    "F_GROWTH_US_EQ",
    "F_GROWTH_EXUS_EQ",
    "F_SECTOR_US_CONSUMER_DISCRETIONARY",
    "F_SECTOR_US_INDUSTRIALS",
    "F_SECTOR_US_MATERIALS",
    "F_SECTOR_US_ENERGY",
    "F_SECTOR_US_TECH",
    "F_SECTOR_US_FINANCIALS",
    "F_SECTOR_US_COMMUNICATIONS",
    "F_SECTOR_US_HEALTHCARE",
    "F_SECTOR_US_CONSUMER_STAPLES",
    "F_SECTOR_US_UTILITIES",
    "F_RATE_US10Y",
    "F_RATE_US10Y_REAL",
    "F_CURVE_US_2Y10Y",
    "F_RATE_KR10Y",
